  ...
  return (
    <section id="journey" className="py-24 px-6 relative">
      <div className="max-w-2xl mx-auto">
        <h2 className="font-pixel text-xl md:text-2xl text-center mb-16 text-white text-glow-gold">OUR JOURNEY</h2>
            ...
            {milestones.map((item, index) => (
              ...
              >
                ...
                <div className="glass-card p-6 rounded-2xl glow-gold overflow-hidden">
                  ...
                  <span className="text-accent text-[10px] font-pixel uppercase tracking-tighter">{item.date}</span>
                  <h3 className="font-pixel text-sm md:text-base text-white mt-3 mb-4 leading-relaxed">{item.title}</h3>
